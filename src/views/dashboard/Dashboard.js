    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Biểu đồ KPI</h4>
              <div className="small text-muted">Tháng 5</div>
            </CCol>
        ...
        {/* <CCardFooter>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              ...
              <strong>29.703 Users (700%)</strong>
              <CProgress
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              ...
              <strong>24.093 Users (300%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="info"
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              ...
              <strong>22.123 Users (300%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="danger"
      ...
      <CRow>
        <CCol>
          <CCard>
            <CCardHeader>
              Đánh giá KPI tháng trước của thành viên HCI 07
            </CCardHeader>
            <CCardBody>
              {/* <CRow>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <CProgress className="progress-xs" color="success" value="85" />
                    </td>
                    {/* <td className="text-center">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <CProgress className="progress-xs" color="danger" value="60" />
                    </td>
                    {/* <td className="text-center">
